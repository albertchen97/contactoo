  ...
  return (
    <div
      className={
        ...
        isMe ? "flex break-words flex-col float-right justify-end m-2 ml-9 mr-5" : "flex flex-col float-right justify-start m-2 ml-5 mr-9"
      }>
      <p className="mb-2 text-sm text-black/70">{isMe ? "" :message.owner}</p>
